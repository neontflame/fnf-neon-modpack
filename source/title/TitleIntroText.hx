...
class TitleIntroText extends MusicBeatState
{
	...
	override function beatHit()
	{
		...
		{
			case 1:
				createCoolText(['neontflame', 'and kowot']);
			case 2:
				addMoreText('proudly present');
			case 4:
				deleteCoolText();
				addMoreText('a mod in development');
			case 5:
				addMoreText('for a year or so');
			case 6:
				addMoreText('with many ideas');
			case 8:
			...
			case 15:
				deleteCoolText();					
			case 16:
				addMoreText('stuck in');
			case 17:
				addMoreText('dev hell');
			case 18:
				addMoreText('until now');
			case 19:
				deleteCoolText();
			case 20:
