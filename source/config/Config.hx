...
class Config
{
	...
	public static var songTimerType:Int;
	public static var vanillaUi:Bool;
	...
	public static function resetSettings():Void{
		...
		FlxG.save.data.songTimerType = 0;
		FlxG.save.data.vanillaUi = false;
		reload();
	...
	public static function reload():Void
	{
		...
		songTimerType = FlxG.save.data.songTimerType;
		vanillaUi = FlxG.save.data.vanillaUi;
	}
								...
								):Void
	{
		...
		FlxG.save.data.songTimerType = songTimerTypeW;
		FlxG.save.data.vanillaUi = vanillaUiW;
	...
	public static function configCheck():Void
	{
		...
		if(FlxG.save.data.songTimerType == null)
			FlxG.save.data.songTimerType = 0;
		if(FlxG.save.data.vanillaUi == null)
			FlxG.save.data.vanillaUi = false;
