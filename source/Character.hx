...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'gf-christmas':
				frames = Paths.getSparrowAtlas("characters/christmas/gfChristmas");
				animation.addByPrefix('cheer', 'GF Cheer', 24, false);
				animation.addByPrefix('singLEFT', 'GF left note', 24, false);
				animation.addByPrefix('singRIGHT', 'GF Right Note', 24, false);
				animation.addByPrefix('singUP', 'GF Up Note', 24, false);
			...
			case 'gf-pixel':
				frames = Paths.getSparrowAtlas("characters/weeb/gfPixel");
			...
			case 'neon':
				...
				animation.addByPrefix('idle', 'neon idle', 24, false);
				animation.addByPrefix('singUP', 'neon up', 24, false);
				animation.addByPrefix('singRIGHT', 'neon right', 24, false);
				animation.addByPrefix('singDOWN', 'neon down', 24, false);
				animation.addByPrefix('singLEFT', 'neon left', 24, false);
				
				addOffset('idle');
				if (!isPlayer) {
				addOffset("singUP", 100, 15);
				addOffset("singRIGHT", -20, -4);
				addOffset("singLEFT", 167, 2);
				addOffset("singDOWN", 62, -24);
				} else {
				addOffset("singUP", -100, 15);
				addOffset("singRIGHT", -167, -4);
				addOffset("singLEFT", 20, 2);
				addOffset("singDOWN", -62, -24);
				}
			...
			case 'coio':
				iconColor = 'FF00338A';
				// COIO ANIMATION LOADING CODE
				frames = Paths.getSparrowAtlas("characters/coio");
				animation.addByPrefix('idle', 'coio idle', 24, false);
				animation.addByPrefix('singUP', 'coio up', 24, false);
				animation.addByPrefix('singRIGHT', 'coio right', 24, false);
				animation.addByPrefix('singDOWN', 'coio down', 24, false);
				animation.addByPrefix('singLEFT', 'coio left', 24, false);
				animation.addByPrefix('cut', 'coio cutscene', 24, false);
				
				addOffset('idle');
				addOffset("singUP", -26, 49);
				addOffset("singRIGHT", -24, -6);
				addOffset("singLEFT", 118, 7);
				addOffset("singDOWN", -18, -68);
				addOffset('cut', 11, 23);
			...
			case 'bf-christmas':
				iconColor = 'FF66FF33';
				frames = Paths.getSparrowAtlas("characters/christmas/bfChristmas");
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
				animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
				animation.addByPrefix('singRIGHT', 'BF NOTE RIGHT0', 24, false);
